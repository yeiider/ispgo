...
export default function Navigation() {
  ...
  return (
    <header className="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
      <nav
        className="mt-4 relative max-w-2xl w-full bg-white border border-gray-200 rounded-lg mx-2 py-2.5 md:flex md:items-center md:justify-between md:py-0 md:px-4 md:mx-auto dark:bg-neutral-900 dark:border-neutral-700">
            ...
            <a className="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80"
              ...
              <svg className="w-24 h-auto" width="116" height="32" viewBox="0 0 116 32" fill="none"
                ...
                <path
                  ...
                  className="stroke-gray-800 dark:stroke-white" stroke="currentColor" strokeWidth="2"/>
                <path
            ...
            {props.isAuthenticated ? (
              <>
                <Link
                  ...
                  href={props.customerDashboardUrl}>{__('Dashboard')}</Link>
                <Link
                  className={twMerge("link", isActive("/customer/logout") && classActive)}
