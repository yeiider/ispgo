      ...
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1
            ...
            your journey with <span className="text-blue-600">Preline</span></h1>
          ...
          <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
            ...
            <div className="py-5">
              ...
              <div className="mt-5">
                {/* Star */}
                <svg className="h-auto w-16 text-gray-800 dark:text-white" width="110" height="28" viewBox="0 0 110 28"
                     fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
        ...
        <div className="relative ms-4">
          <img className="w-full rounded-md"
               ...
               alt="Hero Image"/>
          <div
            className="absolute inset-0 -z-[1] bg-gradient-to-tr from-gray-200 via-white/0 to-white/0 size-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6 dark:from-neutral-800 dark:via-neutral-900/0 dark:to-neutral-900/0"></div>

          {/* SVG*/}
          <div className="absolute bottom-0 start-0">
            <svg className="w-2/3 ms-auto h-auto text-white dark:text-neutral-900" width="630" height="451"
