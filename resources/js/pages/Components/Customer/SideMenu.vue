  ...
  <div class="flex h-screen flex-col justify-between border-e bg-white">
    <div class="px-4 py-6">
      ...
      <div class="flex justify-center">
        <a href="/" style="height:32px; width:auto; display:block">
      ...
      <ul class="mt-6 space-y-1">
        <li>
          <a
            href="#"
            class="block rounded-lg bg-gray-100 px-4 py-3 text-sm font-medium text-gray-700"
          >
            General
          </a>
        </li>
