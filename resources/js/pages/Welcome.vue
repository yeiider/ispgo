...
import girlBooks from './assets/girl-with-books.png'
import trueFalse from './assets/true-false.png'
  ...
  <div class="w-full text-gray-700 bg-cream">
    <div class="flex flex-col max-w-screen-xl px-8 mx-auto md:items-center md:justify-between md:flex-row">
      ...
      <nav :class="{ 'transform md:transform-none': !open, 'h-full': open }"
           class="h-0 md:h-auto flex flex-col flex-grow md:items-center z-10 pb-4 md:pb-0 md:flex md:justify-end md:flex-row origin-top duration-300 scale-y-0">
  ...
  <div class="bg-cream">
    <div class="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
      ...
      <div class="w-full lg:w-6/12 lg:-mt-10 relative" id="girl">
        <img data-aos="fade-up" data-aos-once="true" class="w-10/12 mx-auto 2xl:-mb-20" :src="girl" :alt="girl"/>
        <!-- calendar -->
        <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true"
             class="absolute top-20 -left-6 sm:top-32 sm:left-10 md:top-40 md:left-16 lg:-left-0 lg:top-52 floating-4">
          <img class="bg-white bg-opacity-80 rounded-lg h-12 sm:h-16" :src="calendar" :alt="calendar">
        </div>
        <!-- red -->
        ...
        <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true"
          ...
          <img class="bg-white bg-opacity-80 rounded-lg h-20 sm:h-28" :src="uxClass" :alt="uxClass">
        </div>
        <!-- congrats -->
  ...
  <div class="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="grid grid-cols-3 lg:grid-cols-6 gap-4 justify-items-center">
        ...
        <img class="h-7" :src="airbnb" alt="airbnb">
        <img class="h-7 transform translate-y-2" :src="amazon" alt="amazon">
        <img class="h-7" :src="facebook" alt="facebook">
        <img class="h-7" :src="grab" alt="grab">
      </div>
    </div>
    ...
    <div class="mt-24 flex flex-col md:flex-row items-start md:space-x-10">
      <div data-aos="zoom-in-right" class="md:w-6/12">
        <img class="md:w-8/12 mx-auto" :src="integrations">
      </div>
    ...
    <div class="mt-24 flex flex-col-reverse md:flex-row items-start md:space-x-10">
      <div data-aos="zoom-in-right" class="md:w-5/12">
        ...
        <p class="text-gray-500 my-5 lg:pr-36">Skilline has got more than 100k positive ratings from our users around
          the world.</p>
        ...
        <button
          class="flex items-center space-x-3 pl-3 border-b border-l border-t border-purple text-purple font-medium my-4 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out rounded-full">
          <span>Write your assessment</span>
          <div class="border border-purple h-14 w-14 rounded-full flex items-center justify-center">
